        ...
        if (!this.credentials['sessionCookie']) {
            this.credentials['sessionCookie'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    ...
                    return this.apiKeys['sessionCookie'] || this.apiKeys['GLACIER_SESSION'];
                }
            };
        }

        // init default csrfHeader credential
        if (!this.credentials['csrfHeader']) {
            this.credentials['csrfHeader'] = () => {
                if (this.apiKeys === null || this.apiKeys === undefined) {
                    return undefined;
                } else {
                    return this.apiKeys['csrfHeader'] || this.apiKeys['X-CSRF-Token'];
                }
            };
        }
